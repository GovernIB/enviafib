...
public interface Constants {
    ...
    public static final int[] ESTATS_PETICIO = { ESTAT_PETICIO_REBUTJADA, ESTAT_PETICIO_EN_PROCES, ESTAT_PETICIO_FIRMADA, ESTAT_PETICIO_ERROR,
            ESTAT_PETICIO_ARXIVANT, ESTAT_PETICIO_ERROR_ARXIVANT, ESTAT_PETICIO_ERROR_TANCANT_EXPEDIENT, ESTAT_PETICIO_PROCESANT_CALLBACK, ESTAT_PETICIO_PENDENT_TANCAR_EXPEDIENT, ESTAT_PETICIO_ERROR_CALLBACK  };
