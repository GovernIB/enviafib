...
public interface Constants {
    ...
    public static final int ESTAT_PETICIO_PROCESANT_CALLBACK = 8;
    public static final int ESTAT_PETICIO_PENDENT_TANCAR_EXPEDIENT = 9;

    //FIRMADES
    public static final int ESTAT_PETICIO_FIRMADA = 3;

    //REBUTJADES
    public static final int ESTAT_PETICIO_REBUTJADA = 1;
    public static final int ESTAT_PETICIO_ERROR = 4;
    public static final int ESTAT_PETICIO_ERROR_CALLBACK = 40;

    public static final int[] ESTATS_PETICIO = { ESTAT_PETICIO_REBUTJADA, ESTAT_PETICIO_EN_PROCES,
            ESTAT_PETICIO_FIRMADA, ESTAT_PETICIO_ERROR, ESTAT_PETICIO_ARXIVANT, ESTAT_PETICIO_ERROR_ARXIVANT,
            ESTAT_PETICIO_ERROR_TANCANT_EXPEDIENT, ESTAT_PETICIO_PROCESANT_CALLBACK,
            ESTAT_PETICIO_PENDENT_TANCAR_EXPEDIENT, ESTAT_PETICIO_ERROR_CALLBACK };

    public static final String FIRMADA_PARCIAL = "FIRMADA_PARCIAL";
    ...
    public static final int[] TIPUS_PETICIONS = { TIPUS_PETICIO_NIF, TIPUS_PETICIO_AUTOFIRMA, TIPUS_PETICIO_FLUX,
            TIPUS_PETICIO_PLANTILLAFLUX_USUARI, TIPUS_PETICIO_PLANTILLAFLUX_ENTITAT, TIPUS_PETICIO_FLUX_SIMPLE,
            TIPUS_PETICIO_FLUX_JSON, TIPUS_PETICIO_CARREC_GERENT_PRESIDENT, TIPUS_PETICIO_CARREC_CAPAREA_CONSELLER,
            ...
            TIPUS_PETICIO_CARREC_ADDICIONAL_1, TIPUS_PETICIO_CARREC_ADDICIONAL_2 };
    ...
    public static final int[] CARRECS = { CARREC_GERENT_PRESIDENT, CARREC_CAP_AREA_CONSELLER,
            CARREC_CAP_DEPARTAMENT_DIRECTOR_GENERAL, CARREC_SECRETARI, CARREC_ENCARREGAT_COMPRES,
            CARREC_RECURSOS_HUMANS, CARREC_ADDICIONAL_1, CARREC_ADDICIONAL_2 };
