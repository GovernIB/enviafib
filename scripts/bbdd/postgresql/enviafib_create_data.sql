...
es.caib.enviafib.pluginsib.estructuraorganizativa.mock.carrec2.positionname.es=', true, 1, 'Plugin Mock', 'Plugin Mock que simula entitat Fundació Bit');
...
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (10, 'Autofirma', NULL, 112, 113, 10, 1, NULL, NULL, NULL, true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (11, 'Prova NIF', NULL, 110, 111, 20, 2, NULL, NULL, NULL, true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (12, 'Firma Personalitzada', NULL, 114, 115, 30, 3, NULL, NULL, NULL, true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (13, 'Director General', NULL, 116, 117, 93, 8, NULL, NULL, '3', true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (14, 'Enviar a firmar al/la secretari/a', NULL, 118, 119, 94, 8, NULL, NULL, '4', true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (15, 'Plantilla de flux de firma d´usuari', 'L''usuari seleccionarà entre les seves plantilles de flux de firmes. Això implica que podrà crear Flux de Firma que només veurà ell.', 120, 121, 60, 4, NULL, NULL, NULL, true);
...
# Si no en defineix cap llavors es mostraran totes', NULL, true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (17, 'Gerent President', NULL, 124, 125, 91, 8, NULL, NULL, '1', true);
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu) VALUES (18, 'Conseller', NULL, 126, 127, 92, 8, NULL, NULL, '2', true);
