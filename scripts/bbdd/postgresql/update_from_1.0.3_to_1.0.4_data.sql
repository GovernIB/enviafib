...
INSERT INTO efi_menu(menuid, nom, descripcio, titolmenuid, ajudamenuid, ordre, tipus, grupid, parametretext, parametrecombo, actiu)
   VALUES (10, 'Autofirma', NULL, 112, 113, 10, 1, NULL, NULL, NULL, true);
...
UPDATE efi_peticio SET tipus=14 WHERE tipus=4;
