...
INSERT INTO efi_entitat VALUES ('govern', 'GovernIB', 'Govern de les Illes Balears', '<p><span style="color: #fe0089;"><strong>Govern IB</strong></span></p>
...
VALUES 
    ('govern', 'GovernIB', 'Govern de les Illes Balears', '<p><span style="color: #fe0089;"><strong>Govern IB</strong></span></p><p><span style="color: #999999;">prova prova text</span></p>', true, '662548831', 'www.caib.es', 'suport@caib.es', 30, 31, 32, 33, 'https://www.caib.es/webgoib/que-necessites', 100, 0, true, NULL);
