...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public SerieDocumentalQueryPath SERIEDOCUMENTALS() {
    return new SerieDocumentalQueryPath(new QueryPath() {
      public String getQueryPath() {
          return EntitatQueryPath.this.getQueryPath() + "serieDocumentals" + ".";
      }
    });
  }
*/
