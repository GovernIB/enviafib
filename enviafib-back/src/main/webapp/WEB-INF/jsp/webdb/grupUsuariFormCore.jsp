...
<un:useConstants var="GrupUsuariFields" className="es.caib.enviafib.model.fields.GrupUsuariFields"/>
        ...
        <tr id="grupUsuari_grupID_rowid">
          ...
          <input type="text" readonly="true" class="form-control col-md-9-optional uneditable-input" value="${gen:findValue(__theForm.grupUsuari.grupID,__theForm.listOfGrupForGrupID)}" aria-label="grupUsuari.grupID" />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,GrupUsuariFields.GRUPID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="grupUsuari_grupID"  onchange="if(typeof onChangeGrupID == 'function') {  onChangeGrupID(this); };"  cssClass="form-control col-md-9-optional" path="grupUsuari.grupID"  aria-label="grupUsuari.grupID" >
        ...
        <tr id="grupUsuari_usuariID_rowid">
          ...
          <input type="text" readonly="true" class="form-control col-md-9-optional uneditable-input" value="${gen:findValue(__theForm.grupUsuari.usuariID,__theForm.listOfUsuariForUsuariID)}" aria-label="grupUsuari.usuariID" />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,GrupUsuariFields.USUARIID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="grupUsuari_usuariID"  onchange="if(typeof onChangeUsuariID == 'function') {  onChangeUsuariID(this); };"  cssClass="form-control col-md-9-optional" path="grupUsuari.usuariID"  aria-label="grupUsuari.usuariID" >
