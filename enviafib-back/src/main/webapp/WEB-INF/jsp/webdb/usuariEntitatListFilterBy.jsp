      ...
      <div class="input-group" style="padding-right: 24px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatFields.USUARIENTITATID)}">
            ...
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <label for="usuariEntitat.usuarientitatid" style="display: inline;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatFields.USUARIID)}">
            <div class="input-group" style="padding-right: 24px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <label for="usuariEntitat.usuariid" style="display: inline;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariEntitatFields.ENTITATID)}">
            ...
            <div class="input-prepend" style="padding-right: 24px;padding-bottom: 4px;">
              <label for="usuariEntitat.entitatid" style="display: inline;">
              ...
              <form:input cssClass="search-query input-medium" placeholder="${cercaperentitatid}" path="entitatid" aria-label="usuariEntitat.entitatid" />
            </div>
