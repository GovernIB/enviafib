...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
          ...
          <c:choose>
           <c:when test="${__theFilterForm.actionsRenderer == 1}">
            ...
            <a class="btn btn-info" href="<c:url value="${contexte}/view/${infoSignatura.infoSignaturaID}"/>" role="button"  title="<fmt:message key="genapp.viewtitle"/>">
  ...
  <ul class="dropdown-menu float-right" style="min-width:35px;padding:5px 5px 0px 5px;margin:0px;font-size: 12px" >
            ...
            <c:if test="${__theFilterForm.viewButtonVisible}">
            <li>
            <a class="btn btn-info btn-sm a_item" style="margin-bottom:5px;color: white;" href="<c:url value="${contexte}/view/${infoSignatura.infoSignaturaID}"/>" onclick="null">
            <i class="fas fa-eye"></i>
