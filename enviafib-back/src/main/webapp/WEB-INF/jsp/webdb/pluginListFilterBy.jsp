      ...
      <div class="input-group" style="padding-right: 24px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.PLUGINID)}">
            ...
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <label for="plugin.pluginID" style="display: inline;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.NOM)}">
            ...
            <div class="input-prepend" style="padding-right: 24px;padding-bottom: 4px;">
              <label for="plugin.nom" style="display: inline;">
              ...
              <form:input cssClass="search-query input-medium" placeholder="${cercapernom}" path="nom" aria-label="plugin.nom" />
            </div>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 24px;padding-bottom: 4px;">
              <label for="plugin.descripcio" style="display: inline;">
              ...
              <form:input cssClass="search-query input-medium" placeholder="${cercaperdescripcio}" path="descripcio" aria-label="plugin.descripcio" />
            </div>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.CLASSE)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 24px;padding-bottom: 4px;">
              <label for="plugin.classe" style="display: inline;">
              ...
              <form:input cssClass="search-query input-medium" placeholder="${cercaperclasse}" path="classe" aria-label="plugin.classe" />
            </div>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.PROPERTIES)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 24px;padding-bottom: 4px;">
              <label for="plugin.properties" style="display: inline;">
              ...
              <form:input cssClass="search-query input-medium" placeholder="${cercaperproperties}" path="properties" aria-label="plugin.properties" />
            </div>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.ACTIU)}">
            <div class="input-group" style="padding-right: 24px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <label for="plugin.actiu" style="display: inline;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PluginFields.TIPUS)}">
            <div class="input-group" style="padding-right: 24px;padding-bottom: 4px;">
              ...
              <label for="plugin.tipusSelect" style="display: inline;">
                 <span class="add-on"><fmt:message key="plugin.tipus" />:</span>
              </label>
              </div>

              <div class="input-group-prepend" style="min-width:200px">
                <form:select aria-label="plugin.tipusSelect"   id="efi_plugin_tipus_select" path="tipusSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    var $select = $('#efi_plugin_tipus_select');
