...
<un:useConstants var="UsuariEntitatFields" className="es.caib.enviafib.model.fields.UsuariEntitatFields"/>
        ...
        <tr id="usuariEntitat_usuariid_rowid">
          <td id="usuariEntitat_usuariid_columnlabelid">
            <label for="usuariEntitat.usuariid">
          ...
          <input type="text" readonly="true" class="form-control col-md-9-optional uneditable-input" value="${gen:findValue(__theForm.usuariEntitat.usuariid,__theForm.listOfUsuariForUsuariid)}" aria-label="usuariEntitat.usuariid" />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,UsuariEntitatFields.USUARIID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="usuariEntitat_usuariid"  onchange="if(typeof onChangeUsuariid == 'function') {  onChangeUsuariid(this); };"  cssClass="form-control col-md-9-optional" path="usuariEntitat.usuariid"  aria-label="usuariEntitat.usuariid" >
        ...
        <tr id="usuariEntitat_entitatid_rowid">
          <td id="usuariEntitat_entitatid_columnlabelid">
            <label for="usuariEntitat.entitatid">
          ...
          <input type="text" readonly="true" class="form-control col-md-9-optional uneditable-input" value="${gen:findValue(__theForm.usuariEntitat.entitatid,__theForm.listOfEntitatForEntitatid)}" aria-label="usuariEntitat.entitatid" />
          </c:if>
          <c:if test="${!gen:contains(__theForm.readOnlyFields ,UsuariEntitatFields.ENTITATID)}" >
          <c:set var="containEmptyValue"  value="false" />
          <form:select id="usuariEntitat_entitatid"  onchange="if(typeof onChangeEntitatid == 'function') {  onChangeEntitatid(this); };"  cssClass="form-control col-md-9-optional" path="usuariEntitat.entitatid"  aria-label="usuariEntitat.entitatid" >
