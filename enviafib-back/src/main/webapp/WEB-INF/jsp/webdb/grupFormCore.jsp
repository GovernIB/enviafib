...
<un:useConstants var="GrupFields" className="es.caib.enviafib.model.fields.GrupFields"/>
        ...
        <tr id="grup_nom_rowid">
          ...
          <td id="grup_nom_columnvalueid">
            ...
            <form:input readonly="${ gen:contains(__theForm.readOnlyFields ,GrupFields.NOM)? 'true' : 'false'}" cssClass="w-100 form-control  ${gen:contains(__theForm.readOnlyFields ,GrupFields.NOM)? ' uneditable-input' : ''}"  style="" maxlength="255" path="grup.nom"   />
