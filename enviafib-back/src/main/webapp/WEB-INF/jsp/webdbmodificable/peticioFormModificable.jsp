...
<c:if test="${not empty dragdrop}">
    ...
    <div id="btn-clear-files" class=AdditionalButtonStyle.DANGER onclick="clearAllFiles()"><fmt:message key="btn.clear.all.files" /></div>
    <ul id="ul_files"></ul>
    ...
    function refreshFileList(ALL_FILES){
        ...
        while (i < ALL_FILES.length){
            ...
            if (FLAG.charAt(i) === "F") {
                ...
                //Tamb� l'afegim al llistat total de fitxers, per enviar-los tots
                ...
                //Cuando hemos a�adido el fichero, comprovamos si el siguiente es su anexo...
                ...
                i++;
                //Si el siguiente es anexo, a�adelo. Si no, a�adimos otro fichero
                ...
                //Cuando hemos rellenado el div con el ul con anexos. Lo a�adimos al li. Puede estar vacio      
...
<%-- ==== FER QUE L'OPCI� NULL DE TIPUS DOCUMENTALS PAREXQUI UN PLACEHOLDER ==========  --%>
<script type="text/javascript"> 
...
function validacioFormulario() {
	//<span id="peticio.dataCreacio.errors" class="errorField alert alert-danger">El camp Creada �s obligatori.</span>
	var validacio = true;
	$(".errorField").remove();
    ...
    if (titol.value === "") {
        ...
        span.classList = "errorField alert alert-danger";
        span.innerHTML = "El camp Titol �s obligatori.";
    ...
    if(nif.type != "hidden"){
		...
		if (!regex.test(nif.value)) {
		    ...
		    span.classList = "errorField alert alert-danger";
		    span.innerHTML = "El camp NIF no t� el format correcte.";
    ...
    if (tipusDoc.value === "") {
        ...
        span.classList = "errorField alert alert-danger";
        span.innerHTML = "El Tipus documental �s obligatori.";
...
<script type="text/javascript">
	...
	var btns2 = $(".btn-primary");
	$(btns2).addClass("top-buttons");
	$(".lead").append(btns2);

	var btns1 = $(".btn-success");
	$(btns1).addClass("top-buttons");
	$(".lead").append(btns1);
