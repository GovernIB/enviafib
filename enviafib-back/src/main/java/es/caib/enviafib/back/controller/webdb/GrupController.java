 ...
 * @author GenApp
 */
@MenuOption(labelCode="grup.grup.plural", order=40, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/grup")
@SessionAttributes(types = { GrupForm.class, GrupFilterForm.class })
@Tile(name="grupFormWebDB", contentJsp="/WEB-INF/jsp/webdb/grupForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="grup.grup")})
@Tile(name="grupListWebDB", contentJsp="/WEB-INF/jsp/webdb/grupList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="grup.grup") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Grup
   */
  @RequestMapping(value = "/cancel")
  public String cancelGrup(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Grup_FilterForm_" + this.getClass().getName();
  }
