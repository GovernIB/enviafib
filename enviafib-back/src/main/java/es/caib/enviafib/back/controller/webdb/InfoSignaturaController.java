 ...
 * @author GenApp
 */
@MenuOption(labelCode="infoSignatura.infoSignatura.plural", order=90, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de InfoSignatura
   */
  @RequestMapping(value = "/cancel")
  public String cancelInfoSignatura(HttpServletRequest request,HttpServletResponse response) {
