 ...
 * @author GenApp
 */
@MenuOption(labelCode="menu.menu.plural", order=100, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/menu")
@SessionAttributes(types = { MenuForm.class, MenuFilterForm.class })
@Tile(name="menuFormWebDB", contentJsp="/WEB-INF/jsp/webdb/menuForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="menu.menu")})
@Tile(name="menuListWebDB", contentJsp="/WEB-INF/jsp/webdb/menuList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="menu.menu") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Menu
   */
  @RequestMapping(value = "/cancel")
  public String cancelMenu(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Menu_FilterForm_" + this.getClass().getName();
  }
