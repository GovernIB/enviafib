 ...
 */
@Component
public class MenuRefList extends RefListBase implements MenuFields {
    ...
    public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
        ...
        _w1 = es.caib.enviafib.model.fields.TraduccioFields.TRADUCCIOID.in(menuEjb.getSubQuery(_transSelect, where));
