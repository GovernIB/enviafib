...
public class EntitatRefList extends RefListBase
  ...
  public EntitatRefList() {
    setSelects(new Select<?>[] { ENTITATID.select });
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    ...
    org.fundaciobit.genapp.common.query.Where _w1 = es.caib.enviafib.model.fields.TraduccioFields.TRADUCCIOID.in(entitatEjb.executeQuery(_transSelect, where));
