 ...
 * @author GenApp
 */
@MenuOption(labelCode="serieDocumental.serieDocumental.plural", order=140, group=Tab.MENU_WEBDB)
@Controller
...
@Tile(name="serieDocumentalFormWebDB", contentJsp="/WEB-INF/jsp/webdb/serieDocumentalForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="serieDocumental.serieDocumental")})
@Tile(name="serieDocumentalListWebDB", contentJsp="/WEB-INF/jsp/webdb/serieDocumentalList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="serieDocumental.serieDocumental") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "SerieDocumental_FilterForm_" + this.getClass().getName();
  }
