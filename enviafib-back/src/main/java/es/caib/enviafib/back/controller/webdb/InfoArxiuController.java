 ...
 * @author GenApp
 */
@MenuOption(labelCode="infoArxiu.infoArxiu.plural", order=80, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/infoArxiu")
@SessionAttributes(types = { InfoArxiuForm.class, InfoArxiuFilterForm.class })
@Tile(name="infoArxiuFormWebDB", contentJsp="/WEB-INF/jsp/webdb/infoArxiuForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="infoArxiu.infoArxiu")})
@Tile(name="infoArxiuListWebDB", contentJsp="/WEB-INF/jsp/webdb/infoArxiuList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="infoArxiu.infoArxiu") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de InfoArxiu
   */
  @RequestMapping(value = "/cancel")
  public String cancelInfoArxiu(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "InfoArxiu_FilterForm_" + this.getClass().getName();
  }
