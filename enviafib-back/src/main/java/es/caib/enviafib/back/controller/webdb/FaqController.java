 ...
 * @author GenApp
 */
@MenuOption(labelCode="faq.faq.plural", order=20, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/faq")
@SessionAttributes(types = { FaqForm.class, FaqFilterForm.class })
@Tile(name="faqFormWebDB", contentJsp="/WEB-INF/jsp/webdb/faqForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="faq.faq")})
@Tile(name="faqListWebDB", contentJsp="/WEB-INF/jsp/webdb/faqList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="faq.faq") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Faq
   */
  @RequestMapping(value = "/cancel")
  public String cancelFaq(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Faq_FilterForm_" + this.getClass().getName();
  }
