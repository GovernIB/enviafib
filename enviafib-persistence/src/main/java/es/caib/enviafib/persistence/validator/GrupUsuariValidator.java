...
public class GrupUsuariValidator<I extends GrupUsuari>
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      // Check Unique MULTIPLE for (usuariid, grupid)
      if (__vr.getFieldErrorCount(USUARIID) == 0 && __vr.getFieldErrorCount(GRUPID) == 0) {
        java.lang.Long __usuariid = __target__.getUsuariID();
        java.lang.Long __grupid = __target__.getGrupID();
        Long __count_ = null;
        try { __count_ = __grupUsuariManager.count(org.fundaciobit.genapp.common.query.Where.AND(USUARIID.equal(__usuariid), GRUPID.equal(__grupid))); } catch(org.fundaciobit.genapp.common.i18n.I18NException e) { e.printStackTrace(); };
      ...
      // Check Unique MULTIPLE for (usuariid, grupid)
      if (__vr.getFieldErrorCount(USUARIID) == 0 && __vr.getFieldErrorCount(GRUPID) == 0 && __vr.getFieldErrorCount(GRUPUSUARIID) == 0) {
        java.lang.Long __usuariid = __target__.getUsuariID();
        java.lang.Long __grupid = __target__.getGrupID();
        java.lang.Long __grupusuariid = __target__.getGrupUsuariID();
        Long __count_ = null;
        try { __count_ = __grupUsuariManager.count(org.fundaciobit.genapp.common.query.Where.AND(USUARIID.equal(__usuariid), GRUPID.equal(__grupid), GRUPUSUARIID.notEqual(__grupusuariid))); } catch(org.fundaciobit.genapp.common.i18n.I18NException e) { e.printStackTrace(); };
        if (__count_ == null || __count_ != 0) {        
            __vr.rejectValue(USUARIID, "genapp.validation.unique",
                new org.fundaciobit.genapp.common.i18n.I18NArgumentString(String.valueOf(__usuariid)),
                     new org.fundaciobit.genapp.common.i18n.I18NArgumentCode(get(USUARIID)));
