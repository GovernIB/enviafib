...
public class PeticioJPAManager
    ...
    public synchronized Peticio create( long _titolID_, java.sql.Timestamp _datacreacio_, long _fitxerID_, long _solicitantID_, java.lang.String _idiomaID_, java.lang.String _destinatarinif_) throws I18NException {
        PeticioJPA __bean =  new PeticioJPA(_titolID_,_datacreacio_,_fitxerID_,_solicitantID_,_idiomaID_,_destinatarinif_);
