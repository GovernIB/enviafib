...
public class PeticioJPAManager
    ...
    public Peticio create( java.lang.String _nom_, java.sql.Timestamp _datacreacio_, java.sql.Timestamp _dataFinal_, long _fitxerID_, long _solicitantID_, java.lang.String _idiomaID_, java.lang.String _destinatarinif_, long _estat_, java.lang.Long _fitxerFirmatID_, java.lang.String _tipusdocumental_, java.lang.String _idiomadoc_, java.lang.Long _infosignaturaid_, int _tipus_, java.lang.String _errorMsg_, java.lang.String _errorException_, java.lang.String _peticioPortafirmes_) throws I18NException {
        PeticioJPA __bean =  new PeticioJPA(_nom_,_datacreacio_,_dataFinal_,_fitxerID_,_solicitantID_,_idiomaID_,_destinatarinif_,_estat_,_fitxerFirmatID_,_tipusdocumental_,_idiomadoc_,_infosignaturaid_,_tipus_,_errorMsg_,_errorException_,_peticioPortafirmes_);
